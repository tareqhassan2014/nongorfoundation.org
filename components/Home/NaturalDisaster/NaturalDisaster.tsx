    ...
    return (
        <div className="mt-36 max-w-6xl mx-auto font-serif px-1 lg:px-0">
            ...
            <div className="mt-14 flex gap-10 flex-col lg:flex-row ">
                <Image src="/home/natural-disaster.Banner.jpg" alt="Banner image" height={650} width={650} className="object-cover rounded-lg" />
                                ...
                                <p className="py-5">
                                    {data?.details?.length && data.details.length > 140 ? (
                                        <>
                                            ...
                                            <Link href="/pages/natural-disaster" className="pl-3 underline text-red-500 font-semibold text-sm">Read more</Link>
                                        </>
                                    ) : (
                                        <>{data?.details}</>
                                    )}
