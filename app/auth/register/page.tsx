  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gradient-to-r from-[#59BFDF] to-[#E739F5]">
      <div className="w-full lg:max-w-xl mx-auto h-screen lg:max-h-[850px] lg:rounded-lg rounded-none py-10 px-10 bg-white">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="text-[#afa7ad] relative">
                      ...
                      <Input
                        className="pl-8 border-2 border-t-0 border-l-0 border-r-0 rounded-none focus-visible:ring-0"
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="text-[#afa7ad] relative">
                        ...
                        <Input
                          className="pl-8 border-2 border-t-0 border-l-0 border-r-0 rounded-none focus-visible:ring-0"
                          placeholder="Please inter your first name"
                          {...field}
                        />
                      </div>
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="text-[#afa7ad] relative">
                        ...
                        <Input
                          className="pl-8 border-2 border-t-0 border-l-0 border-r-0 rounded-none focus-visible:ring-0"
                          placeholder="Please inter your last name"
                          {...field}
                        />
                      </div>
                    </FormControl>
        ...
        <h5 className="text-sm font-semibold text-[#afa7ad] text-center mt-8 mb-3">
          Or Sign Up Using
        </h5>
        <div className="flex gap-4 items-center justify-center ">
          <button>
            <FaFacebook className="h-[50px] w-[50px] text-[#3f5a92] " />
          </button>
          <button>
            <AiFillTwitterCircle className="h-14 w-14 text-[#4e9fe8] " />
          </button>
          <button>
            <AiFillGoogleCircle className="h-14 w-14 text-[#d74f3d] " />
          </button>
        </div>

        <p className="text-center pt-8 text-md font-semibold text-[#afa7ad]">
          Al ready have an account please{" "}
          <Link href={paths.auth.login} className="underline text-red-400">
            Sign in
          </Link>
        </p>
      </div>
