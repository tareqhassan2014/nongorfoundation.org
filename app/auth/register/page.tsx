            ...
            <div className='w-full lg:max-w-xl mx-auto h-screen lg:max-h-[850px] lg:rounded-lg rounded-none py-10 px-10 bg-white'>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className='text-[#afa7ad] relative'>
                                                ...
                                                <button type='button' className='absolute bottom-2 right-1' onClick={toggleConfirmPasswordVisibility}>
                                                    {
                        ...
                        <Button variant={'custom'} className='w-full rounded-full' type="submit">Sign Up</Button>
                    </form>
                </Form>
