  ...
  return (
    <main>
      ...
      <div className=" max-w-[1000px] mx-auto mt-10 py-10">
        {/* form header */}
        <div className=" mb-10 ">
          <h1 className=" font-serif text-center w-full text-5xl font-semibold">
            Register Now
          </h1>
          <h4 className=" text-center w-full text-orange-400 mt-5">
            JOIN US NOW
          </h4>
        </div>
        ...
        <div className=" grid lg:grid-cols-2 md:grid-cols-1 gap-10 p-5">
          ...
          <section>
            ...
            <div className=" flex flex-col gap-5 mt-5">
              ...
              <p className=" text-slate-500 lg:w-[80%] w-full">
                ...
                Molestiae animi dolorum corrupti, unde recusandae aspernatur!
                Distinctio ex at temporibus soluta cum, fuga delectus ipsa
          ...
          <section>
            <form className=" flex flex-col gap-5 justify-start">
              ...
              <div>
                <button className=" bg-gradient-to-r from-[#59BFDF] to-[#E739F5] text-white p-3 rounded-md text-lg " type="submit">
                  Send Message
                </button>
              </div>
            </form>
